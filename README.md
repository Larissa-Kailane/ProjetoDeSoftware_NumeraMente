...
[Sobre](#-sobre-o-projeto) · [Funcionalidades](#-funcionalidades) · [Tecnologias](#-tecnologias) · [Requisitos](#-requisitos-do-sistema) 
...
| **Servidor** | Linux (Ubuntu/Debian) + WSGI |
| **Design** | Figma |
| **Hospedagem (prevista)** | Render ou PythonAnywhere |
